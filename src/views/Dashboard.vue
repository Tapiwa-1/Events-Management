<template>
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <router-link v-if="authStore.isAdmin" to="/admin/packages" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-indigo-600 dark:text-indigo-500">Packages</h5>
            <p class="font-normal text-gray-700 dark:text-gray-400">Create and update dynamic package prices for the landing page.</p>
        </router-link>
